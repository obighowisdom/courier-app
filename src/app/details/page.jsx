        ...
        >
          <Flex>
            <div className="flex w-[100%] flex-col gap-6 overflow-hidden">
              ...
              <div className="flex flex-wrap items-center justify-between rounded-md bg-dark-700 p-5 gap-7">
                <Stepper />
                ...
                <TableContainer>
                  <Table variant="striped" colorScheme="red">
                    ...
                    <Tbody>
                      <Tr>
                        <Td>
                          <b className="text-purple-900">Officer in Charge:</b> Dell
                          345 corei5 3455GB SSD ...
                        </Td>
                      </Tr>
                      <Tr>
                        <Td>
                          <b className="text-purple-900">Comment:</b> Air Freight{" "}
                        </Td>
                      </Tr>
                  ...
                  <TableContainer>
                    <Table variant="striped" colorScheme="red">
                      ...
                      <Tbody>
                        <Tr>
                          <Td>
                            <b className="text-purple-900">Description:</b> Dell
                            345 corei5 3455GB SSD ...
                          </Td>
                        </Tr>
                        <Tr>
                          <Td>
                            <b className="text-purple-900">Mode:</b> Air Freight{" "}
                          </Td>
                        </Tr>
                        ...
                        <Tr>
                          {" "}
                          <Td>
                            <b className="text-purple-900">Delivery Address:</b>{" "}
                            234 Olando PMB X5674667{" "}
                          </Td>
                        </Tr>
                        <Tr>
                          <Td>
                            <b className="text-purple-900">Delivery Date</b> 23
                            October 2024
                          </Td>
                        </Tr>
                        <Tr>
                        ...
                        <Tr>
                          <Td>
                            <b className="text-purple-900">Officer In-Charge</b>{" "}
                            Davidson Ryan
                          </Td>
                        </Tr>
                        <Tr>
                          <Td>
                            <b className="text-purple-900">Comment: </b> Picked
                            up for delivery{" "}
                          </Td>
                        </Tr>
                      </Tbody>
